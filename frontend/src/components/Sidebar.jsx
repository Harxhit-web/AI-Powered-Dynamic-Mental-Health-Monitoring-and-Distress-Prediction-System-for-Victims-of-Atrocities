...
const menuItems = [
  ...
  { name: "Check-ins", icon: ClipboardCheck, to: "/check-in" },
  { name: "Wellbeing", icon: Activity, to: "/wellbeing" },
  { name: "Appointments", icon: CalendarDays, to: "/appointments" },
  { name: "Talk with Saathi", icon: MessageSquare, to: "/talk-with-saathi", badge: 3 },
  { name: "Notifications", icon: Bell, badge: 2 },
];

const counselorMenuItems = [
  { name: "Dashboard", icon: LayoutDashboard, to: "/counselor/dashboard", end: true },
  { name: "My profile", icon: User, to: "/counselor/profile" },
  { name: "Caseload", icon: ClipboardCheck, to: "/counselor/caseload" },
  { name: "Analytics", icon: Activity, to: "/counselor/analytics" },
